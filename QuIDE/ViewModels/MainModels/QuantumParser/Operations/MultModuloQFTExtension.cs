...
namespace AvaloniaGUI.ViewModels.MainModels.QuantumParser.Operations
{
    ...
    {
        public static void MultModuloQFT(this QuantumComputer comp, ulong a, ulong N, Register x, Register b,
            RegisterRef control)
        {
            if (comp.Group)
            {
        ...
        public static void InverseMultModuloQFT(this QuantumComputer comp, ulong a, ulong N, Register x, Register b,
            RegisterRef control)
        {
            if (comp.Group)
            {
        ...
        public static void MultModuloQFT(this QuantumComputer comp, ulong a, ulong N, RegisterRef ctrl, Register x,
            Register b, RegisterRef control)
        {
            if (comp.Group)
            {
        ...
        public static void InverseMultModuloQFT(this QuantumComputer comp, ulong a, ulong N, RegisterRef ctrl,
            Register x, Register b, RegisterRef control)
        {
            if (comp.Group)
            {
                object[] parameters = new object[] { comp, a, N, ctrl, x, b, control };
