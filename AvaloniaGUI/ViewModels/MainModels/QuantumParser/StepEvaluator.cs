            ...
            while (i < maxI)
            {
                ...
                switch (gate.Name)
                {
                    ...
                    case GateName.PhaseKick:
                        ...
                        {
                            int[] controls1 = pk.Controls.Select<RegisterRefModel, int>(x => x.OffsetToRoot)
                                .ToArray<int>();
                            if (runBackward)
                            {
                    ...
                    case GateName.CPhaseShift:
                        ...
                        {
                            int[] controls1 = cps.Controls.Select<RegisterRefModel, int>(x => x.OffsetToRoot)
                                .ToArray<int>();
                            if (runBackward)
                            {
                    ...
                    case GateName.InvCPhaseShift:
                        ...
                        {
                            int[] controls1 = icps.Controls.Select<RegisterRefModel, int>(x => x.OffsetToRoot)
                                .ToArray<int>();
                            if (runBackward)
                            {
