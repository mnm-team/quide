...
namespace Quantum.Operations
{
    ...
    public static class GatesExtension
    {
        ...
        {
            var root = comp.GetRootRegister(control, target);
            var c = control.OffsetToRoot;
            var t = target.OffsetToRoot;
        ...
        {
            var root = comp.GetRootRegister(comp.GetRootRegister(controls), target);
            root.Toffoli(target.OffsetToRoot, controls.Select(x => x.OffsetToRoot).ToArray());
        }
        ...
        /// <param name="target">The reference to target qubit.</param>
        /// <param name="controls">
        ///     The references to control qubits. If there is no control qubit given, the gate is run
        ///     unconditionally.
        /// </param>
        public static void CPhaseShift(this QuantumComputer comp, int dist, RegisterRef target,
            params RegisterRef[] controls)
        {
            if (controls.Length == 0)
            {
                var root = comp.GetRootRegister(target);
                var t = target.OffsetToRoot;
                root.CPhaseShift(dist, t);
            }
            else
            {
                var root = comp.GetRootRegister(target, comp.GetRootRegister(controls));
                var t = target.OffsetToRoot;
                root.CPhaseShift(dist, t, controls.Select(x => x.OffsetToRoot).ToArray());
            }
        }
        ...
        /// <param name="target">The reference to target qubit.</param>
        /// <param name="control">
        ///     Optional argument. If given, the method performs controlled gate operation. Destribes the
        ///     reference to control qubit.
        /// </param>
        public static void Gate1(this QuantumComputer comp, Complex[,] matrix, RegisterRef target,
            RegisterRef? control = null)
        {
            if (control.HasValue)
            {
                var root = comp.GetRootRegister(control.Value, target);
                var c = control.Value.OffsetToRoot;
                var t = target.OffsetToRoot;
        ...
        /// <param name="target">The reference to target qubit.</param>
        /// <param name="control">
        ///     Optional argument. If given, the method performs controlled gate operation.
        ///     Destribes the reference to control qubit.
        /// </param>
        ...
        ///     unconditionally.
        /// </param>
        public static void InverseCPhaseShift(this QuantumComputer comp, int dist, RegisterRef target,
            params RegisterRef[] controls)
        {
            if (controls.Length == 0)
            {
            ...
            else
            {
                var root = comp.GetRootRegister(target, comp.GetRootRegister(controls));
                var t = target.OffsetToRoot;
                root.InverseCPhaseShift(dist, t, controls.Select(x => x.OffsetToRoot).ToArray());
            }
        }
        ...
        ///     Destribes the reference to control qubit.
        /// </param>
        public static void PhaseKick(this QuantumComputer comp, double gamma, RegisterRef target,
            params RegisterRef[] controls)
        {
            if (controls.Length == 0)
            {
            ...
            else
            {
                var root = comp.GetRootRegister(target, comp.GetRootRegister(controls));
                var t = target.OffsetToRoot;
                root.PhaseKick(gamma, t, controls.Select(x => x.OffsetToRoot).ToArray());
            }
        }
        ...
        ///     Destribes the reference to control qubit.
        /// </param>
        public static void PhaseScale(this QuantumComputer comp, double gamma, RegisterRef target,
            RegisterRef? control = null)
        {
            if (control.HasValue)
            {
        ...
        ///     Destribes the reference to control qubit.
        /// </param>
        public static void RotateX(this QuantumComputer comp, double gamma, RegisterRef target,
            RegisterRef? control = null)
        {
            if (control.HasValue)
            {
        ...
        ///     Destribes the reference to control qubit.
        /// </param>
        public static void RotateY(this QuantumComputer comp, double gamma, RegisterRef target,
            RegisterRef? control = null)
        {
            if (control.HasValue)
            {
        ...
        ///     Destribes the reference to control qubit.
        /// </param>
        public static void RotateZ(this QuantumComputer comp, double gamma, RegisterRef target,
            RegisterRef? control = null)
        {
            if (control.HasValue)
            {
